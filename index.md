...
This policy outlines the guidelines for professionals using artificial intelligence (AI) to generate answers for Learners in the CareerVillage community. We are revising our approach based on learner feedback and we will likely change it in the future as things continue to evolve. 

*Artificial intelligence (AI) can be a powerful tool to help enhance responses, generate insights, and support community learning. However, it is essential to use AI responsibly to maintain the authenticity and quality of interactions within the community. By adhering to these guidelines, Professionals can foster genuine connections and a supportive environment.*

**Definitions**
- **AI-Only-Generated-Content**:  Content created entirely by an AI system without human input.
- **Hybrid Content**: Content created with AI assistance but reviewed and significantly edited by a human before submission. This includes using CareerVillage's AI-based enhancement features for Q&A answers.
- **Human-Generated Content**: Content that is fully created from human input and without the use of AI.

  
**Policy**
1. **AI-Only Generated Content**: CareerVillage does not allow for the usage of AI-Only-Generated Content. While we see the value of AI, we also understand that this platform is centered around fostering human connection and connecting learners with real mentors. To help maintain our community, culture, and values, these types of answers will be deleted. Because we are using human judgment to make these determinations, it is possible that we incorrectly flag something as AI. To help combat human error, we will contact the user and offer an opportunity to appeal the decision and reinstate the advice. 
2. **Hybrid Content**: When used with human oversight, AI can help enhance advice written by Professionals. These tools can help make advice more effective, and efficient, and improve the overall tone. We allow for Hybrid content. 
3. **Content Standards**: Hybrid content must meet the same standards as human-generated content. It should be well-written, informative, and relevant. Responses should not merely repeat information without adding new insights. Professionals must add their own personal experience, knowledge, or tailored advice to make the content meaningful.
4. **Quality Control and Accuracy**: Professionals are responsible for checking content created with the help of  AI for accuracy, relevance, and alignment with current industry standards. AI can sometimes introduce errors or biases, so all responses should be reviewed carefully to ensure they are up-to-date and free from misinformation or bias.
5. **Stand by Your Advice**: The advice you post is yours. Regardless of whether you use AI or not, you are responsible for the content and **should stand by every word**. If AI was used, it must have been incorporated in a way that aligns with your expertise and the needs of the learner.
   
Content that violates this policy may be deleted or adjusted as needed. CareerVillage is committed to ensuring that content aligns with these guidelines to uphold the community's quality and authenticity. 
...
- Edit or update the content with a note clearly stating that an admin made changes and why.
...
As AI technology continues to evolve, the AI policy may be updated. We are committed to regularly reviewing and revising the policy to reflect new developments in AI and its impact on the CareerVillage community. If your content is flagged and you believe it was incorrectly identified as AI-generated, please let us know so we can improve our approach.

This policy helps ensure that AI is used ethically and responsibly within the CareerVillage community, maintaining high standards of personalized, expert-driven advice.
...
- Updated 2/11/2025 G. Lally - Update to AI policy 
